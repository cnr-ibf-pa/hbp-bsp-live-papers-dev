        ...
        if ($scope.block.segments[$scope.currentSegmentId].analogsignals[0] == undefined) {
            ...
            SegmentData.get({url: $scope.source,
                ...
                function(data) {
                    ...
                    if ($scope.currentSegmentId==0){
                        $scope.block.segments[$scope.currentSegmentId].name = "Detailed model"
                    }else{
                        $scope.block.segments[$scope.currentSegmentId].name = "Reduced model"
                    }
                    console.log(data);
